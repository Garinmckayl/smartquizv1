...
/**
 * REST controller for managing {@link com.anchormind.smartquiz.domain.Quiz}.
 */
@RestController
@RequestMapping("/api")
public class QuizResource {
    ...
    public ResponseEntity<QuizDTO> updateQuiz(@Valid @RequestBody QuizDTO quizDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, quizDTO.getId()))
            .body(result);
    }
